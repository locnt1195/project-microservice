			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					<li><a href="/" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
					<li><a href="/videos" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Videos</a></li>
					<li><a href="/upload" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Upload</a></li>
				  </ul>
				...
				<div class="footer-grids">
					...
					<div class="footer-bottom">
						<ul>
							...
							<li><a href="/" class="f-history">History</a></li>
							<li><a href="/" class="play-icon popup-with-zoom-anim f-history f-help">Help</a></li>
						</ul>
					</div>
				</div>
			</div>
